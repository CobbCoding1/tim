...
char *token_type_text[TYPE_COUNT + 1] = {
    "type_none""nop","push","push_ptr","push_str","get_str","pop","pop_str","dup","dup_str","indup","indup_str",
    "swap","swap_str","inswap","inswap_str","add","sub", "mul","div", "mod","add_f","sub_f","mul_f","div_f",
    "mod_f","cmpe","cmpne","cmpg","cmpl","cmpge","cmple","call","ret","jmp","zjmp","nzjmp","print", 
